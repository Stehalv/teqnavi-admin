...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  try {
    ...
    if (!authResult || !authResult.session) {
      console.error('No session found:', authResult); // Debug log
    ...
    return json({
      session: session, // Return session data
    });
  } catch (error) {
...
export default function Index() {
  ...
  return (
    <Page>
      <TitleBar title="Teqnavi Admin Panel">
              ...
              <BlockStack gap="500">
                <BlockStack gap="200">
                  <Text as="h2" variant="headingMd">
                    {"Congrats on creating a new Shopify app \u{1F389}"}
                  </Text>
